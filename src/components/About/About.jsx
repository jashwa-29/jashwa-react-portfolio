  ...
  return (
    <div className='about'>
      ...
      <div className="abt-flex">
        <div className="abt-img" data-aos="zoom-in-right">
          <img src={require('../../Assets/about-img.webp')} alt="" />
        </div>
        <div className="abt-content" data-aos="zoom-in-left">
            <h3>Web Developer and Designer</h3>
            <p>As a Dedicated Full stack Web Developer with <br/> Entry level experience in creating visually <br/> appealing and user-friendly websites. Proficient <br /> in HTML, CSS, and JavaScript, React with a <br /> strong foundation in responsive design and <br /> cross-browser compatibility.</p>
        </div>
      </div>

      <div className='education'>
            <h3>EDUCATION</h3>
            <div className='ed-box'  data-aos="flip-left">
